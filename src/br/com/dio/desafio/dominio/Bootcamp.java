...
public class Bootcamp {
	...
	@Override
	public int hashCode() {
		return Objects.hash(dataFinal, dataInicial, descricao, devsInscritos, conteudos, nome);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return Objects.equals(dataFinal, other.dataFinal) && Objects.equals(dataInicial, other.dataInicial)
				...
				&& Objects.equals(conteudos, other.conteudos) && Objects.equals(nome, other.nome);
	}
